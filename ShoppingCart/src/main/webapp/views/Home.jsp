...
.carousel-inner > .item > a > img {
  min-height: 300px; 
  min-width: 300px;   /* Set slide height here */
...
<nav class="navbar navbar-inverse navbar-top">
  ...
  <div class="container-fluid bg-3 text-center">
    <div class="navbar-header">
          <a class="navbar-brand" href="hi"><font  face="Gadget" size=5 color="white"><span style=padding-right:20px><img src="<c:url value="/resources/images/logo.jpg"/>" width="30" height="30">Mobile Hub</font> <i> <sub>live..love..talk..!!!</sub></span></a></i>
